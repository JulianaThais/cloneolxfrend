...
const Page = () => {
  ...
  const handleSubmitModal = async (e) => {
    ...
    if(!categoryModal.trim()) {
      errors.push("É necessario informar uma categoria")
    }
    if(errors.lenght === 0) {
  ...
  setPriceNegotiableModal(props.priceNegotiabledModal);
  setPriceModal(props.priceModal);
  setDescriptionModal(props.descriptionModal);
  setImagesModal(props.imagesModal);
            ...
            <form onSubmit={handleSubmitModal}>
              ...
              <div className="area--input">
                <input
                  ...
                  value={adTitleModal}
                  onChange={(e) =>
                    setAdTitleModal(e.target.value)}
                  required
                />
              </div>
            </label>
