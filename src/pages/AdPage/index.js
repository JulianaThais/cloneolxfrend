  ...
  <PageArea>
   ...
   <div className="adImage">{loading && <Fake height={300} />}
    {adInfo.images &&
      ...
      <div key={k} className="esch-slide">
        <img src={img} alt="" />
      </div>
      )}
       </slide>}
      ...
      <div className="adName">
        ...
        {adInfo.dataCreated &&
        <small>
          Criando em {formatDate(adInfo.dataCreated)}
        </small>
        }
        </div>
      <div className="adDescription">
        ...
        <hr />
        {adInfo.views &&
        <small>Visualizações:{adInfo.views}
        </small>}
       </div>
       </div>
       </div>
        ...
        <div className="rightSide">
          ...
          <>
          <a
          herf={`mailto:${adInfo.userInfo.email}`}
          tardet="_blank"
          ...
          >
           ...
           <strong>Email: {adInfo.userInfo.email}</strong>
           <strong>Estado: {adInfo.userInfo.stateName}</strong>
          </div>
          </>
          }
